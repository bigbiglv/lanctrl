...
```mermaid
graph LR
    lanctrl-mobile[lanctrl-mobile] -- HTTP / WebSocket --> lanctrl-pc[lanctrl-pc]
```

## 📦 子项目

- **lanctrl-pc**：运行在电脑上的原生后台服务（核心）。
- **lanctrl-mobile**：基于 Flutter 的移动端控制应用。
...
```text
.
├── lanctrl-pc        # PC端核心服务 (Rust)
└── lanctrl-mobile    # 移动端应用 (Flutter)
```
